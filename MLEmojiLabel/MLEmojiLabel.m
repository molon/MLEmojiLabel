...
const CGFloat kEmojiMargin = 2.0f;
const CGFloat kEmojiWidth = 16.5+kEmojiMargin*2;
...
- (NSMutableAttributedString*)mutableAttributeStringWithEmojiText:(NSString*)emojiText
{
    ...
    for (NSTextCheckingResult *result in emojis) {
		...
		NSString *imageName = [[MLEmojiLabel emojiDictionary] objectForKey:emojiKey];
		if (imageName) {
			...
			NSString *rSubStr = [emojiText substringWithRange:range];
