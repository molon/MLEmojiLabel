...
- (MLEmojiLabel *)emojiLabel1
{
    if (!_emojiLabel1) {
        ...
        _emojiLabel1.text = @"/:|-)TableView github:https://github.com/molon/MLEmojiLabel @撒旦 哈哈http://192.168.0.2:8080哈哈#九歌#九黎电话13612341234邮箱13612341234@qq.com旦192.168.0.2:8080旦/:dsad旦/::)sss/::~啊是大三https://192.168.0.2:8080的拉了/::B/::|/:8-)/::</::$/::X/::Z/::'(/::-|/::@/::P/::D/::O/::(/::+/:--b/::Q/::T/:,@P/:,@-D/::d/:,@o/::g/:|-)/::!/::L/::>/::,@/:,@f/::-S/:?/:ok/:love/:<L>/:jump/:shake/:<O>/:circle/:kotow/:turn/:skip/:oY链接:http://baidu.com dudl@qq.com";
